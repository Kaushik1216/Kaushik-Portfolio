          ...
          <div className=" col-12 mx-auto">
            <div className="row">
              ...
              >
                {/* <div></div> */}
                <motion.div>
                  <div className="codeup text-center">
                    {`${code.firstline}`}
                    <br />
                    {`${code.second}`}
                    <br id="break" />
                  ...
                  <motion.h5 variants={item} initial="hidden" animate="visible">
                    <p id="title">
                      Hi
                      <sup>
                        <img src={hand} style={{ height: "40px" }} />
                      </sup>
                      I'm
                    </p>
                  </motion.h5>
                  ...
                  <h3 id="devinfo" style={{ color: `${themecolor.headcolor}` }}>
                    <span
                      onMouseEnter={() => {
                        codechange("Coder");
                      }}
                  ...
                  <div
                    className="row socialIcon text-start"
                    style={{
                      display: `${
                  ...
                  >
                    ...
                    >
                      ...
                      <a
                        target="_blank"
                        rel="noreferrer"
                        href="https://github.com/Kaushik1216"
                      >
                        <Github></Github>
                      </a>
                    </motion.div>
              ...
              <div className="col-md-6 col-12" id="imgdiv">
                <figure class="image-container">
                  <div class="aspect-ratio-box" id="homeimg">
                    <img
                      src={me}
                      alt="Kaushik"
                      class="cropped-image"
