...
export default function Navbar(props) {
  ...
  return (
    ...
    <nav className='menu-nav'>
      <div className="logo">
        <h2 onClick={homePage}style={{color:`${props.headcolor}`}}>
      ...
      <div className="menu-link" >
        <ul >
          <li style={{color:`${active.home===true?`${props.headcolor}`:`${props.text}`}`}} onClick={homePage}>Home</li>
          <li style={{color:`${active.about===true?`${props.headcolor}`:`${props.text}`}`}} onClick={about}>About</li>
          <li style={{color:`${active.skills===true?`${props.headcolor}`:`${props.text}`}`}} onClick={skills}>Skills</li>
          <li style={{color:`${active.project===true?`${props.headcolor}`:`${props.text}`}`}} onClick={project}>Project</li>
          <li style={{color:`${active.contact===true?`${props.headcolor}`:`${props.text}`}`}} onClick={contact}>Contact</li>
        </ul>
      </div>
