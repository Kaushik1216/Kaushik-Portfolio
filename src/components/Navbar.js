    ...
    <nav className='menu-nav'>
      ...
      <div className="menu-link" >
        <ul >
          ...
          <li style={{color:`${active.skills===true?`${themecolor.headcolor}`:`${themecolor.textcolor}`}`}} onClick={skills}>Experience</li>
          <li style={{color:`${active.project===true?`${themecolor.headcolor}`:`${themecolor.textcolor}`}`}} onClick={project}>Work</li>
      ...
      <i className={`fa-solid fa-1x fa-sun`} style={{display:themecolor.background==="#0B1D2A"?"":"none  "}} onClick={()=>dispatch(darktheme())}></i>
