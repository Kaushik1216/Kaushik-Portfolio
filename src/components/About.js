  ...
  return (
   ...
   <p className='topic'style={{color:`${themecolor.headcolor}`}}>About Me</p>
    ...
    <div className="col-md-6 col-push-12" id="smallimgdiv">
      ...
      <br/> I have recently developed many webdevelopment and machine-learning projects.I am a quick learner and am always eager to take on new challenges and expand my skill set. 
      <br/>
      <br/>
      </p>
      <div className="row">
