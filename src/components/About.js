    ...
    <div className="row mx-auto">
      ...
      <div className="row">
        ...
        <div className="row">
          ...
          <ul >
          <li ><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>C++</li>
          <li><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>Python</li>
          <li><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>React JS</li>
        </ul>
          </div>
          <div className="col-6" style={{color:`${themecolor.textcolor}`}}>
          <ul typeof='disk'>
          <li><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>Node JS</li>
          <li><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>ML</li>
          <li><i class="fa-solid fa-arrow-right"style={{color:`${themecolor.headcolor}`}}></i>Robotic's</li>
        </ul>
          </div>
        </div>
